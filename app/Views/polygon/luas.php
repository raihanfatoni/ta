...
<div class="row">
    <div class="card">
        <div class="card-body">
            <?= form_open('PolygonKecamatan/polygonsumedang') ?>
...
<script>
    ...
    function getColor(d) {
		return d > 42.22955558 ? '#66ff33' :
           d > 4.941944425 ? '#ffff00' :
                                    '#ff0000';
        console.log('jml',d);
    }
    ...
    info.update = function (props) {
            ...
            '<b> Kecamatan \t: ' + props.nama + '</b><br/>' + '<a> Akumulasi Luas Tanah Wakaf \t:' + props.akumulasiluastanah + ' ha </a><br/>' 
    ...
    legend.onAdd = function (map) {
        ...
        var div = L.DomUtil.create('div', 'info legend'),
            grades = [0, 4.941944425, 42.22955558],
            labels = [];
